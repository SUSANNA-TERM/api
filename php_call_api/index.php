...
$postdata = '{"meter_id":2,"id":"string2","type":"string","metertype_id":0,"type_id":0,"mote":"string","barcode":"string","consumer":"string","provision":"string","lat":"string","lng":"string","address":"string","description":"string","location_id":0,"address_name":"string"}';
$command = 'Meters';
...
$call = rest_call("PUT", $command, $postdata);
if ($call) {
	print_r($call);
	if ($call->success)
		echo 'Success';
